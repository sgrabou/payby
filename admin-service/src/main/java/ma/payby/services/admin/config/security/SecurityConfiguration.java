package ma.payby.services.admin.config.security;
    ...
    public static class KeycloakConfigurationAdapter extends KeycloakWebSecurityConfigurerAdapter {
        ...
        protected void configure(HttpSecurity http) throws Exception
        {
            ...
            http
                    ...
                    .antMatchers("/v2/api-docs", "/configuration/**", "/swagger*/**", "/webjars/**","/logout", "/", "/unsecured").permitAll()

                    .and()
                    .authorizeRequests()
                    .antMatchers("/api/v1/merchant").hasRole("ADMIN")
