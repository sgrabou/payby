package ma.payby.services.merchand.controller;
...
import ma.payby.services.merchand.service.OrderService;
...
public class MerchandController {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(MerchandController.class);
    ...
    public ResponseEntity<InitierPaymentMerchandResponseDTO> add(@RequestBody InitierPaymentMerchandRequestDTO initierPaymentMerchandRequestDTO) throws BusinessException{
        LOGGER.info("Order add: {}", initierPaymentMerchandRequestDTO);
        return new ResponseEntity<>(orderService.addOrder(initierPaymentMerchandRequestDTO), HttpStatus.OK);
    }
