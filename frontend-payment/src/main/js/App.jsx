...
class App extends Component {
	constructor(props) {
		super(props);
		this.state = {reference: this.props.reference, merchandOrderID: null,amount: null, orderDetails: null,
			merchandUrlWebsite: null,customerFirstName: null,customerLastName: null,customerAddress: null,
			customerMobileNumber: null,customerEmail: null,logo: null,walletName:null, walletLogo:null };
	}
	componentDidMount() {
